<?php 
$pageTitle='ACSE 2020 Call for Papers'; //THIS MUST BE SET FOR EACH PAGE
...
<div class="text">
	<div style="font-weight: bold">
		Call for Papers <a style="color:red" href="https://easychair.org/conferences/?conf=acse2020 " target="_blank">Please click here to submit your paper</a>.
	</div>
...
We are seeking high quality papers from researchers, professionals, and innovators on but not limited to the following topics:
		<ul style="list-style: disc; margin-left: 3%">
			<li>
Software Engineering research addressing social-economic challenges in the areas of importance for the African continent including but not limited to: Financial Services
Agriculture, 
...
Energy (e.g., smart grids), and
Conflict and Crisis Management	</li>
			<li>
	...
	<h1>Submission Guidelines and Evaluation</h1>
	<p>
	...
	<p class="bd">
		<ul>
			<li>1. Full techincal papers limited to 8 pages describing technical research results or industrial experience</li>
			<li>2. Short papers (Posters) limited to 4 pages describing preliminary results of work-in-progress research.</li>
		</ul>
	</p>
	...
	Works must be submitted in PDF format via <a style="color:red" href="https://easychair.org/conferences/?conf=acse2020" target="_blank">EasyChair</a>.
	</p>
