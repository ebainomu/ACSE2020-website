				...
				<div id="top" class="flex">
 				...
 				<div id="content" class="flex-auto">
	 				<ul class="list-reset">
	 					...
	 					?>
	 					<li style="font-size:small;color:red;text-transform:uppercase;cursor:pointer"><a target="_blank" href="resources/ACSE2020-cfp.pdf">Download the call for papers</a></li>
					</ul>
				</div>
